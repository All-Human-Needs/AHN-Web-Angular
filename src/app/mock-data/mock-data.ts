...
export const RegisteredBusinesses: Business[] = [
    ...
    { id: "001", name: 'Groote Schuur Hospital', lat: -33.9217137, lng: 18.46171849, maxCapacity: 60 },
    { id: "002", name: 'Netcare UCT Private Academic Hospital', lat: -33.9423756, lng: 18.4632473, maxCapacity: 60 },
    { id: "003", name: 'Life Vincent Pallotti Hospital', lat: -33.9443605, lng: 18.4900986, maxCapacity: 60 },
    { id: "004", name: 'Nedbank Salt River Cape', lat: -33.931401, lng: 18.4550689, maxCapacity: 60 },
    { id: "005", name: 'Nedbank Grand Central', lat: -33.923951, lng: 18.422884, maxCapacity: 60 },
    { id: "006", name: 'Nedbank Foreshore', lat: -33.91724, lng: 18.4272859, maxCapacity: 60 },
    { id: "007", name: 'Department of Home Affairs Cape Town', lat: -33.92765, lng: 18.4221, maxCapacity: 60 },
    { id: "008", name: 'Department of Home Affairs Office', lat: -33.9012178, lng: 18.63154910000003, maxCapacity: 60 },
    { id: "009", name: 'Home Affairs Wynberg District', lat: -34.0032484, lng: 18.4700239, maxCapacity: 60 },
]
